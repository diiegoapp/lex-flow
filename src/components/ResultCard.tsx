      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex flex-wrap gap-2 pt-2">
          ...
          {result.subtema_sugerido && (
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-full bg-purple-500/10 border border-purple-500/20 text-xs font-medium text-purple-300">
              <Tag className="w-3.5 h-3.5" />
              {result.subtema_sugerido}
            </div>
          )}
